...
namespace AKMLogic
{
	...
	public class AkmSetup
	{
		...
		private static void LoadAkmAppConfig()
		{
			...
			if (!IsConfigValid(_akmAppConfigs))
			{
		...
		private static IKey[] CreateInitialKeys(int relationshipId)
		{
			...
			{
				var key1 = new AkmKey(32); key1.SetKeyFromString("NnY5eSRCJkUpSCtNYlFlVGhXbVpxNHQ3dyF6JUMqRi0=");
				var key2 = new AkmKey(32); key2.SetKeyFromString("eiRDJkYpSEBNY1FmVGpXblpyNHU3eCFBJUQqRy1LYU4=");
				var key3 = new AkmKey(32); key3.SetKeyFromString("NnY5eSRCJkUpSCtNYlFlTWhXbVpxNHQ3dyF6JUMqRm8=");
				var key4 = new AkmKey(32); key4.SetKeyFromString("eiRDJkYpSEBNY1FmVGpXYVpyNHU3eCFBJUQqRy1LYXQ=");
		...
		private static bool IsConfigValid(IDictionary<int, AkmAppConfig> configs)
		{
			bool isValid = true;
